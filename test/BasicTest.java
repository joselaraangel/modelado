...
public class BasicTest extends UnitTest {
    ...
    public void createAndRetrieveUser() {
        ...
        new User("jose@gmail.com", "1234", "Jose").save();

        // Retrieve the user with jose username
        User jose = User.find("byEmail", "jose@gmail.com").first();

        // Test 
        assertNotNull(jose);
        assertEquals("Jose", jose.fullname);
    }
    ...
    public void tryConnectAsUser() {
        ...
        // Test 
        assertNotNull(User.connect("jose@gmail.com", "1234"));
        assertNull(User.connect("jose@gmail.com", "badpassword"));
